...
*************************************************************/
	require_once "/var/www/admin.pro-po.store/helpers/simple_html_dom.php";

	// Set the output file name.
	$file = "/var/www/pro-po.store/sitemap.xml";

	// Set the start URL. Here is http used, use https:// for 
	// SSL websites.
	$start_url = "https://pro-po.store/";       
...
echo "https://pro-po.store/sitemap.xml";
?>